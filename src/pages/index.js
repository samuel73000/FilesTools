  ...
  return (
    <section className='section-home'>
      ...
      <p className="sous-titre-home">
        Tous les outils dont vous avez besoin pour utiliser les PDF, à portée de
        main. Ils sont tous 100% GRATUITS et simples d'utilisation ! Fusionnez,
        divisez, compressez, convertissez, faites pivoter, déverrouillez et
        ajoutez un filigrane à vos PDF en seulement quelques clics.
      </p>
      </div>
      <div className='container-all-outils-home'>
        <div className='container-outils'>
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Fusionner PDF</p>
            <p className='texte-outil'>
              Combinez plusieurs fichiers PDF en un seul document PDF. Fusionnez
              des PDF en quelques secondes.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Diviser PDF</p>
            <p className='texte-outil'>
              Séparez un PDF en plusieurs fichiers PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            <svg
              ...
              <path
                ...
                fill-rule='evenodd'
                fill='rgb(56.078431%,73.72549%,36.470588%)'></path>
              <path
            ...
            <p className='titre-outil'>Compresser PDF</p>
            <p className='texte-outil'>
              Réduisez la taille de vos fichiers PDF sans perdre en qualité.
            </p>
          </div>
          ...
          <div className='container-outil'>
            <svg
              ...
              <path
                ...
                fill-rule='evenodd'
                fill='rgb(86.27451%,89.803922%,98.039216%)'></path>
              <path
                ...
                fill='rgb(16.078431%,34.117647%,58.431373%)'></path>
              <path
                ...
                fill-rule='evenodd'
                fill='rgb(37.254902%,51.372549%,77.647059%)'></path>
              <path
            ...
            <p className='titre-outil'>PDF en Word</p>
            <p className='texte-outil'>
          ...
          <div className='container-outil'>
            <svg
              ...
              <path
                ...
                fill-rule='evenodd'
                fill='rgb(95.294118%,85.098039%,80%)'></path>
              <path
                ...
                fill='rgb(81.568627%,27.058824%,14.901961%)'></path>
              <g fill-rule='evenodd'>
                <path
            ...
            <p className='titre-outil'>PDF en PowerPoint</p>
            <p className='texte-outil'>
              Convertissez vos fichiers PDF en présentations PowerPoint.
            </p>
          </div>
          ...
          <div className='container-outil'>
            <svg
              ...
              <g fill-rule='evenodd'>
                <path
                  d='M22.855 17.676H44.82c1.8 0 2.453.188 3.113.543.648.344 1.184.875 1.527 1.527.352.656.54 1.31.54 3.11V44.82c0 1.8-.187 2.453-.54 3.113a3.69 3.69 0 0 1-1.527 1.527c-.66.352-1.312.54-3.113.54H22.855c-1.8 0-2.453-.187-3.113-.54-.648-.344-1.18-.88-1.527-1.527-.352-.66-.54-1.312-.54-3.113V22.855c0-1.8.188-2.453.54-3.113.348-.648.88-1.18 1.527-1.527.66-.352 1.313-.54 3.113-.54zm0 0'
                  fill='rgb(36.862745%,63.137255%,38.431373%)'></path>
                <path
            ...
            <p className='titre-outil'>PDF en Excel</p>
            <p className='texte-outil'>
              Transformez vos fichiers PDF en tableurs Excel.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Word en PDF</p>
            <p className='texte-outil'>
              Convertissez vos documents Word en fichiers PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>PowerPoint en PDF</p>
            <p className='texte-outil'>
              Convertissez vos présentations PowerPoint en fichiers PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Excel en PDF</p>
            <p className='texte-outil'>
              Transformez vos feuilles Excel en fichiers PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Modifier PDF</p>
            <p className='texte-outil'>
              Modifiez votre fichier PDF en ajoutant des annotations ou du
              texte.
            </p>
          </div>
          ...
          <div className='container-outil'>
            <svg
              ...
              <path
                d='M32.324 15.656h-9.55c-2.477 0-3.375.258-4.28.742a5.06 5.06 0 0 0-2.098 2.102c-.484.902-.742 1.8-.742 4.277v9.55H5.18c-1.8 0-2.453-.187-3.113-.54a3.69 3.69 0 0 1-1.527-1.527C.188 29.598 0 28.945 0 27.145V5.18c0-1.8.188-2.453.54-3.113A3.69 3.69 0 0 1 2.066.539C2.727.188 3.38 0 5.18 0h21.965c1.8 0 2.453.188 3.113.54a3.69 3.69 0 0 1 1.527 1.527c.352.66.54 1.313.54 3.113zm0 0'
                fill-rule='evenodd'
                fill='rgb(98.431373%,93.72549%,65.882353%)'></path>
              <path
                d='M14.477 7.52c0-.477-.395-.863-.883-.863s-.883.387-.883.863v3.844L7.566 6.316a.89.89 0 0 0-1.246 0c-.168.16-.258.38-.258.61s.1.453.258.613l5.145 5.05H7.55c-.488 0-.883.387-.883.867s.395.863.883.863h6.047a.85.85 0 0 0 .34-.066c.215-.086.387-.254.477-.47.05-.102.066-.215.066-.328l.004-5.934zm0 0'
                fill='rgb(71.764706%,62.745098%,0.392157%)'></path>
              <g fill-rule='evenodd'>
                <path
                  d='M22.855 17.676H44.82c1.8 0 2.453.188 3.113.543.648.344 1.184.875 1.527 1.527.352.656.54 1.31.54 3.11V44.82c0 1.8-.187 2.453-.54 3.113a3.69 3.69 0 0 1-1.527 1.527c-.66.352-1.312.54-3.113.54H22.855c-1.8 0-2.453-.187-3.113-.54-.648-.344-1.18-.88-1.527-1.527-.352-.66-.54-1.312-.54-3.113V22.855c0-1.8.188-2.453.54-3.113.348-.648.88-1.18 1.527-1.527.66-.352 1.313-.54 3.113-.54zm0 0'
            ...
            <p className='titre-outil'>PDF en JPG</p>
            <p className='texte-outil'>
              Convertissez vos fichiers PDF en images JPG.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>JPG en PDF</p>
            <p className='texte-outil'>
              Convertissez vos images JPG en fichiers PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Signer PDF</p>
            <p className='texte-outil'>
              Ajoutez une signature à votre fichier PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            <svg
              ...
              <path
                ...
                fill-rule='evenodd'
                fill='rgb(67.058824%,41.176471%,57.647059%)'></path>
              <path
            ...
            <p className='titre-outil'>Filigrane</p>
            <p className='texte-outil'>
              Ajoutez un filigrane à vos fichiers PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Faire pivoter PDF</p>
            <p className='texte-outil'>
              Faites pivoter vos pages PDF selon vos besoins.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>HTML en PDF</p>
            <p className='texte-outil'>
              Convertissez des pages HTML en fichiers PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Déverrouiller PDF</p>
            <p className='texte-outil'>
              Retirez les mots de passe des fichiers PDF protégés.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Protéger PDF</p>
            <p className='texte-outil'>
              Ajoutez un mot de passe pour protéger votre fichier PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>PDF en PDF/A</p>
            <p className='texte-outil'>
              Convertissez vos fichiers PDF en format PDF/A pour l'archivage.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Réparer PDF</p>
            <p className='texte-outil'>
              Réparez les fichiers PDF corrompus ou endommagés.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Numéros de pages</p>
            <p className='texte-outil'>
              Ajoutez des numéros de pages à votre PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>Numérisation au format PDF</p>
            <p className='texte-outil'>
              Numérisez vos documents et enregistrez-les au format PDF.
            </p>
          </div>
          ...
          <div className='container-outil'>
            ...
            <p className='titre-outil'>OCR PDF</p>
            <p className='texte-outil'>
              Extraire le texte d'un fichier PDF avec OCR.
            </p>
          </div>
          ...
          <div className='container-outil'>
            <svg
              ...
              <path
                fill='#E8EDF3'
                d='M29 26.918a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1v-5Z'></path>
              <rect
                width='7'
                height='2'
                x='29'
              ...
              <path
                fill='#BCD1E6'
                d='M12 17.918a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1v-5Z'></path>
            </svg>
            <p className='titre-outil'>Comparer PDF</p>
            <p className='texte-outil'>
              Comparez deux fichiers PDF pour détecter les différences.
            </p>
          </div>
          ...
          <div className='container-outil'>
            <svg
              ...
              <path
                fill='#4A7AAB'
                d='M7.692.917h32.616c2.675 0 3.645.279 4.623.802a5.452 5.452 0 0 1 2.268 2.268c.523.978.801 1.948.801 4.622v32.617c0 2.674-.279 3.644-.801 4.622a5.452 5.452 0 0 1-2.268 2.268c-.978.523-1.948.801-4.623.801H7.692c-2.675 0-3.645-.278-4.623-.8a5.452 5.452 0 0 1-2.268-2.269C.278 44.87 0 43.9 0 41.226V8.609c0-2.674.278-3.644.801-4.622A5.452 5.452 0 0 1 3.07 1.719c.978-.523 1.948-.802 4.623-.802Z'></path>
              <path
                fill='#E8EDF3'
                fill-rule='evenodd'
              ...
              <path
                fill='#fff'
                d='M12 18.102a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v7.615a2 2 0 0 1-2 2H14a2 2 0 0 1-2-2v-7.614Z'></path>
              <path
                fill='#4A7AAB'
                fill-rule='evenodd'
            ...
            <p className='titre-outil'>Censurer PDF</p>
            <p className='texte-outil'>
              Censurez des informations sensibles dans votre PDF.
            </p>
          </div>
        </div>
      </div>
